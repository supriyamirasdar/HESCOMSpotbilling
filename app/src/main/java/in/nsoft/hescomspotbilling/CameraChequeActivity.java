...
public class CameraChequeActivity extends Activity implements SensorEventListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPreview = new CameraPreview(CameraChequeActivity.this, SVCamera);
		...
		btnSave.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				if(!isCaptured)
				{
					CustomToast.makeText(CameraChequeActivity.this, "Please Capture Photo to Proceed.", Toast.LENGTH_SHORT);
					return;
				}
				else
				{
					...
					//CollectionChequeActivity.isFromChequeDDCamera = true; //Nitish 13-02-2015
					Intent i = new Intent(CameraChequeActivity.this, CollectionChequeActivity.class);
					startActivity(i);
				}
			}
		});
		...
		btnRetake.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				{
					Intent i = new Intent(CameraChequeActivity.this, CameraChequeActivity.class);
					startActivity(i);
				}
			}
		});
	...
	public void onBackPressed() {
		Intent i = new Intent(CameraChequeActivity.this, CollectionActivity.class);
		startActivity(i);
	}
	@Override
	...
	PictureCallback jpegCallback = new PictureCallback() {
		...
		public void onPictureTaken(byte[] data, Camera camera) {
			...
			CustomToast.makeText(CameraChequeActivity.this, "If READING is Not Visible Please Retake Photo", Toast.LENGTH_LONG);
		}
	};
