...
public class Billing extends Activity {
	...
	int f;
	private Button btn, btnprev, btnpnext, btnCollection,btnBillingMap;	
	private TextView conid, rrNo, tariffCode, load, billed, txtBillingMtd;	
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnBillingMap = (Button)findViewById(R.id.btnBillingMap); //27-04-2021
				...
				{	
					...
					try {
						try
						{
							...
							{
								if(LoginActivity.SimNumber == null)
								{
									CustomToast.makeText(Billing.this,"SIM NOT INSERTED/ENABLED." , Toast.LENGTH_SHORT);
									return;
								}
							}
						}
						...
						{
							CustomToast.makeText(Billing.this,"Please Enable AutoDateTime Feature." , Toast.LENGTH_SHORT);
							return;
						}
					}
					catch (Exception e1) {
					...
					if(btn.getText().equals(ConstantClass.btnOKText))
					{
						...
						else
						{
							try
							{
								...
								String cMonth = currentdate.substring(3, 5);
								String  cYear = currentdate.substring(8,10);
								if(!BillingObject.GetBillingObject().getmForMonth().equals(cMonth+cYear))
								{
									CustomToast.makeText(Billing.this, "Month Year Mismatch. Kindly Load Current Month File And Correct Your Mobile Date Time.", Toast.LENGTH_LONG);					
									return;
								}
							}
							catch(Exception e)
					...
					else if(btn.getText().equals(ConstantClass.btnReprintText))//Re-Print Start
					{
						...
						{
							//Bluetooth Code===========================================			
							bptr = new BluetoothPrinting(Billing.this);
							try 
							{
								ringProgress = ProgressDialog.show(Billing.this, "Please wait..", "Re-Printing...",true);//Spinner
		...
		btnCollection.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				{
					CustomToast.makeText(Billing.this,"Please Load SBM File to Database." , Toast.LENGTH_SHORT);
					return;		
				}
				CollectionActivity.isFromBilling = true; //Nitish 29-05-2014
				Intent i = new Intent(Billing.this,CashCounterSyncActivity.class);
				startActivity(i);
				//CustomToast.makeText(Billing.this, "Collection Process under construction." , Toast.LENGTH_SHORT);
			}
		});
		//Nitish End 17-03-2014
	...
	{	
		public void run()
		{
			...
			//Modified 20-10-2020 for AMIGOS
			try 
			{
				///////////////////////////////////////////////Definition Start/////////////////////////////////////
